...
Write-Host "  1. make port-forward-grafana   (separate terminal - MCP uses http://127.0.0.1:3000)"
Write-Host "  2. make enable-mcp-grafana"
Write-Host "  3. Restart Cursor IDE"
Write-Host "  4. make verify-mcp-grafana"
